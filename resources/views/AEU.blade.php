    ...
    <div class="user-interaction-section p-8 bg-white rounded-lg  mt-8">
        ...
        <section class="degree-level-section">
            ...
            <div class="faculty-container-grid grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Department of Information Technology and Law -->
                <div class="faculty-card">
                    <h3>Department of Information Technology and Law</h3>
                    <ul>
                        <li><span class="checkmark">✓</span> Department of Information Technology</li>
                ...
                <div class="faculty-card">
                    ...
                    <ul>
                        ...
                        <li><span class="checkmark">✓</span> Department of Other Activities</li>
                    </ul>
                </div>
