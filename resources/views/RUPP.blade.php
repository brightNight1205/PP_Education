...
<section class="university-overview">
    <!-- User Interaction (Rating and Favorite) -->
    <div class="user-interaction-section p-8 bg-white rounded-lg  mt-8">
        ...
        <section class="degree-level-section mt-8">
            ...
            <div class="faculty-container-grid grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Faculty of Science -->
                ...
                <div class="faculty-card">
                    ...
                    <ul>
                        ...
                        <li><span class="checkmark">✓</span> Department of Economic Development</li>
                        <li><span class="checkmark">✓</span> Department of Natural Resources Management and Development</li>
                    </ul>
                </div>
                ...
                <div class="faculty-card">
                    ...
                    <ul>
                        <li><span class="checkmark">✓</span> Department of Educational Studies</li>
                        <li><span class="checkmark">✓</span> Department of Higher Education Development and Management</li>
                        <li><span class="checkmark">✓</span> Department of Lifelong Learning</li>
                    </ul>
                </div>
                ...
                <div class="faculty-card">
                    ...
                    <ul>
                        <li><span class="checkmark">✓</span> Department of Chinese</li>
                        <li><span class="checkmark">✓</span> Department of English</li>
                        <li><span class="checkmark">✓</span> Department of French</li>
                        <li><span class="checkmark">✓</span> Department of Japanese</li>
                        <li><span class="checkmark">✓</span> Department of Korean</li>
                        <li><span class="checkmark">✓</span> Department of Thai</li>
                    </ul>
                </div>

                <!-- Institute of International Studies and Public Policy -->
                <div class="faculty-card">
                    <h3>Institute of International Studies and Public Policy</h3>
                    <ul>
                        <li><span class="checkmark">✓</span> Department of International Relations</li>
                        <li><span class="checkmark">✓</span> Department of International Economies</li>
                        <li><span class="checkmark">✓</span> Department of Political Science and Public Policy</li>
                        <li><span class="checkmark">✓</span> Department of Vietnamese Studies</li>
                    </ul>
                </div>
        ...
        <section class="graduate-programs-section mt-8">
            ...
            <div class="program-links flex flex-col items-center space-y-2">
                <a href="{{ route('m_rupp') }}" class="underline text-blue-600 hover:text-blue-800">
                    Master's Degree
                </a>
                <a href="{{ route('dc_rupp') }}" class="underline text-blue-600 hover:text-blue-800">
                    Ph.D.'s Degree
                </a>
            </div>
        </section>
