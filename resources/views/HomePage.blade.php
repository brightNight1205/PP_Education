...
<nav class="bg-white p-4 shadow-md fixed w-full z-20 top-0 start-0 border-b border-gray-200">
    <div class="container mx-auto flex flex-wrap items-center justify-between">
        ...
        <a href="{{ route('home') }}" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="../Images/Logo.png" class="h-10 rounded-full" alt="Edu-Guide Logo" />
        ...
        <section class="university">
            ...
            <div class="card-container">
                <div class="scroll-container">
                    ...
                    <div class="card">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQB6vrmmCfFuNUBgW2VuOF2nfEGSQP8zazthw&s" alt="Faculty of Education">
