        ...
        <section class="degree-level-section">
            ...
            <div class="faculty-container-grid grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="faculty-card">
                    ...
                    <ul>
                        <li><span class="checkmark">✓</span> Computer Science (B, M)</li>
                        <li><span class="checkmark">✓</span> Data Science</li>
                        <li><span class="checkmark">✓</span> Digital Media</li>
                        <li><span class="checkmark">✓</span> Cybersecurity</li>
                    </ul>
                </div>
